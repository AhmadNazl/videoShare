        ...
        <div class="container-full">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-12">
                    ...
                    <div id="logo">
                        <a href="{{route('index')}}" class="label label-default">خانه</a>
                    </div>
                </div><!-- // col-md-2 -->
                <div class="col-lg-3 col-md-3 col-sm-6 hidden-xs hidden-sm row">
                    <div class="search-form col-lg-10">
             ...
             <!-- Authentication Directive laravel -->
                @auth
